...
public class ZookeeperTest {
    ...
    public void connect() throws IOException {
        zooKeeper = new ZooKeeper("192.168.11.93:2181,192.168.11.93:2182,192.168.11.93:2183", SESSION_TIMEOUT, watcher);
    }
    ...
    public void testSetData() {
        ...
        Assert.assertNotNull(stat);
        try {
            List<ACL> list = zooKeeper.getACL("/zk001", stat);
            for (ACL acl : list) {
                LOGGER.info("ACL result : {}", JSONObject.toJSONString(acl));
            }
    ...
    public void testGetChild() {
        try {
            zooKeeper.create("/zk", "zk".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
